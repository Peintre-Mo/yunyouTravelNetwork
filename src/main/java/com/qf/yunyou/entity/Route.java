...
public class Route implements Serializable {
    ...
    private cn.itcast.travel.domain.Category category;//所属分类
    private cn.itcast.travel.domain.Seller seller;//所属商家
    ...
    public cn.itcast.travel.domain.Category getCategory() {
        return category;
    }

    public void setCategory(cn.itcast.travel.domain.Category category) {
        this.category = category;
    }

    public cn.itcast.travel.domain.Seller getSeller() {
        return seller;
    }

    public void setSeller(cn.itcast.travel.domain.Seller seller) {
        this.seller = seller;
    }
